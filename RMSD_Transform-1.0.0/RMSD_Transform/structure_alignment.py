...
def structure_alignment(changed_pdb, unchanged_pdb, select_para, log_file, out_pdb =""):
    if not out_pdb:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="This module is for structure alignment")
    ...
    structure_alignment(changed_pdb, unchanged_pdb, select_para, log_file, out_pdb)